...
<div class="">
    <div class="row d-flex" style="color:#00498d;">
            ...
            <div class="col-lg-5 project-home-text pt210m0 /*pb90m50*/ pb920it inditeamtext ftmsection resize-text M90L" style="margin-top:0px; padding-left:90px; padding-right:15px;max-width: 550px;">  
