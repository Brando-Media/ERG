...
<?php if($images): ?>
    ...
    <div class="row m-0">
        ...
        <?php foreach($images as $k=>$image): ?>
           ...
           <div class="col-md-2 container" style="padding-left:0px!important; padding-right:0px!important;  max-width: 16.666667vw; margin-left:0px!important; margin-right:0px!important; width:100%;" >
