                ...
                <div class="">
                    <div class="row" style="color:#fff;">
                            ...
                            <?php foreach($services as $servicerow){ 
                                if($first==0){?>
                                    <button class="accordionproject" style="border-top: 1px solid #fff; outline: none!Important;"><span style="font-size:24px;"><?php echo $servicerow['project_title']?></span></button>
