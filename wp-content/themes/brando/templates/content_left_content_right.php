...
<div class="container  container--small main-content align-self-center padleft25 globalpl0ml0 padleft25 ml0" style="padding-top:80px; margin-top:20px; min-width:310px;">
        <div class="row d-flex" style="min-width:300px; padding-top:20px;">
        <div class="col-lg-6 align-self-center left-content-work-block globalbtext globalcontent globalpl0ml0 nopl" style="margin-bottom:0px;">
    ...
    <div class="row d-flex" style='margin-bottom:20px;'>
        <div class="col-lg-6 align-self-center left-content-work-block globalbtext globalcontent nopl">
