...
<?php if($images): ?>
    ...
    <div class="row m-0">
        ...
        <?php foreach($images as $k=>$image): ?>
           ...
           <?php } ?>
           <a data-rel=”lightbox” href=<?php echo $image['url']?> data-rel=”lightbox” style="height:100%;">
           <div class="col-md-12 container casestudy-div-img maxwidth16 " style="padding-left:0px!important; padding-right:0px!important; margin-left:0px!important; margin-right:0px!important; width:100%;" >
