...
<section class=" white-bg " data-section-name="hover_images">
    <div style="";>
        <div onclick="" class="row services-experts" style="margin-left:0px; margin-right:0px; min-width:100vw;"> 
            ...
            <div class="col-lg-3 container imghoverw" style="padding-left:0px; padding-right:0px; margin-left:0px; margin-right:0px;" >
            ...
            <div onclick="" class="col-lg-3 container imghoverw" style="padding-left:0px; padding-right:0px; margin-left:0px; margin-right:0px;">
