...
<section class="section servicesoverviewbg" data-section-name="hover_images">
    <div style="";>
    <div class="row services-experts servicesoverviewcontent servicespb servicesmargin padleft99110 noml" style="margin:auto;"> 
            ...
            <?php foreach($services as $servicerow){
                if($servicerow['text_location']=="Bottom"){ ?>
                    ...
                    <div class="col-lg-3" style="padding-left:0px; padding-right:0px;">
                        ...
                        <div class="servicescontent nomarginl991 nomarginr991 padright99110">
                ...
                <?php }else if($servicerow['text_location']=="Top"){ ?>
                    <div class="col-lg-3" style="padding-left:0px; padding-right:0px;">
                        <div class="servicescontent nomarginl991 nomarginr991 padright99110" style=""><div class="servicesubtitle" style="color:white;"><?php echo $servicerow['title']; ?></div>
