...
<div class="">
    <div class="row d-flex" style="color:#00498d; /*padding-bottom:100px;*/">
            <div class="col-lg-8 text-center left-content-work-block pt200m100cs" style=" padding-left:50px; padding-right:70px; /* max-width:85%; padding-left:35px;*/">
                <div class="project-home-image-75vw indicasestudyhideimage" style="margin:0px; float:right;">
                    <?php if($image): ?>
                        <img class="img-fluid img-phome project59vwimage" src="<?php echo show_image($image['url'], $image['width'], $image['height']); ?>">
                    <?php endif; ?>
                </div>
...
<div id="wrapper" class="<?php echo $class; ?> ">
        <header id="" class="arrowposproject" style="">
            <div id="top" class="container clearfix header-toggle-white header-div casestudiesmarginleft" style="margin-left:60px; max-width:2400px; padding-left:0px; padding-right:0px;">
