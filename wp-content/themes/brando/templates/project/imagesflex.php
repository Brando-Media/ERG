        ...
        <?php foreach($images as $k=>$image): ?>
           ...
           <div class="<?php echo $class ?> col-md-12 container  casestudy-div-img maxwidth23 hfcproj from50to100p <?php echo $class ?>" style="padding-left:0px!important; padding-right:0px!important; margin-left:0px!important; margin-right:0px!important; width:100%;" >
                                <div class="casestudyhover" style="position:relative;">
                                    ...
                                    <img style="/*max-width:100vw!important;*/" class="maxwidth23 hfcproj from50to100p" src="<?php echo show_image($image['url'], $images[0]['width'], $images[0]['height'], 75) ?>">
...
<?php endif; ?>
    ...
    <div class="row m-0 posabs991">
        ...
        <div class="row m-0">
        <?php foreach($images as $k=>$image): ?>
           <div class="<?php echo $class ?> doublecasestudy50" style="min-width:33.333vw;">
...
<?php endif; ?>
    ...
    <div class="row m-0 posabs991" style="width:100vw;">
        ...
        <div class="row m-0">
        <?php foreach($images as $k=>$image): ?>
           <div class="<?php echo $class ?> triplecasestudyw33" style="min-width:33.333%;">
...
<?php endif; ?>
    ...
    <div class="row m-0 posabs991">
        ...
        <div class="row m-0">
        <?php foreach($images as $k=>$image): ?>
           <div class="<?php echo $class ?>" style="min-width:50%;">
           <div class="<?php echo $class ?> col-md-12 container  casestudy-div-img maxwidth23 hfcproj from50to100p <?php echo $class ?>" style="padding-left:0px!important; padding-right:0px!important; margin-left:0px!important; margin-right:0px!important; width:100%;" >
                                <div class="casestudyhover" style="position:relative;">
                                    <a href="<?php echo $image['url'] ?>" data-rel="lightbox">
...
padding-right: 0px;">
    ...
    <?php foreach($images as $k=>$image): ?>
       ...
       <?php } ?>
       <div class="<?php echo $class ?> projstaticdiv" style="min-width:50%;"> 
