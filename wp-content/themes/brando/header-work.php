    ...
    <body <?php body_class(); ?>>
        ...
        <div id="wrapper" class="<?php echo $class; ?>">
            ...
            <header id="header" style="margin-right:7%;">
                ...
                <div class="container clearfix header-toggle-white header-div" style="margin-left:60px; max-width:2400px; padding-left:0px; padding-right:0px;"  >
                  ...
                  <!--  <nav class="navbar navbar-expand-lg navfloat" id="navfloatx">
                   ...
                   <button id="navbar-header-toggle" onclick="togglemob();" class="navbar-toggler collapsed"  type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse navbaritemz" id="navbarTogglerDemo02" style="padding-top:80px; min-width:100vw; float:left;">
                        ...
                        <li class="nav-item">
                            <a style="color:white; font-weight:bold;" class="nav-link" href="http://brando.media/erg/sectors/">Projects</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="collapse navbar-collapse navbaritemz" id="navbarTogglerDemo02">
                    ...
                    <li class="nav-item">
                        <a style="color:white; font-weight:bold;" class="nav-link navhover" href="http://brando.media/erg/sectors/">Projects</a>
                    </li>
                    <li class="nav-item">
