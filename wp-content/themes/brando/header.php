                ...
                <div class="container clearfix header-toggle-white header-div" style="margin-left:60px; max-width:2400px;">
                   ...
                   <!-- <nav class="navbar navbar-expand-lg navfloat" id="navfloatx">
                    ...
                    <div class="collapse navbar-collapse navbaritemz" id="navbarTogglerDemo02" style="padding-top:0px;">
                        ...
                        <li class="nav-item">
                            <a style="color:white; font-weight:bold;"  class="nav-link navhover" onclick="hrefMove()" href="https://brando.media/erg/#about/" >About <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a style="color:white;font-weight:bold;" class="nav-link navhover" onclick="hrefMove()" href="https://brando.media/erg/#global/"  >Global</a>
                        </li>
                        <li class="nav-item">
                            <a style="color:white;font-weight:bold;" class="nav-link navhover" href="team-page">Team</a>
                        </li>
                        <li class="nav-item">
                            <a style="color:white;font-weight:bold;" class="nav-link navhover" onclick="hrefMove()" href="https://brando.media/erg/#contact/"  >Contact</a>
                        </li>
                        </ul>
                    </div>
              <!--      </nav> -->
