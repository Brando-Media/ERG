...
<html <?php language_attributes(); ?>>
   ...
   <header id="header" style="margin-right:7%;">
       ...
       <div id="top" class="container clearfix header-toggle-white header-div"  style="margin-top:20px; margin-left:60px; max-width:2400px; padding-left:0px; padding-right:0px;">
