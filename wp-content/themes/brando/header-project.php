        ...
        <div id="wrapper" class="<?php echo $class; ?>">
            <header id="header">
                <div class="container clearfix">
                    ...
                    <img class="white-logo" src="<?php bloginfo('template_url') ?>/assets/images/ergbluelogo.png" alt="erg" title="Brando Media" />
                        <img class="red-logo" src="<?php bloginfo('template_url') ?>/assets/images/ergbluelogo.png" alt="erg" title="Brando Media" />
                    </a>
                    <?php if(have_rows('content', 2)): ?>
                        <nav id="main-menu-blue" class="float-right">
                            <ul>
